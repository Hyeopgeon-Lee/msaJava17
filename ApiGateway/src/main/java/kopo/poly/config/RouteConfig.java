...
public class RouteConfig {
    ...
    public RouteLocator routeLocator(RouteLocatorBuilder builder) {
        ...
        final String noticeUri = String.format("%s://%s:%s", noticeProtocol, noticeHost, noticePort);
        final String userUri = String.format("%s://%s:%s", userProtocol, userHost, userPort);
